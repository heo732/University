...
public class Square1 implements IRoot
{
    ...
    public Square1(double a, double b, double c)
    {
        _a = a;
        _b = b;
        _c = c;
    ...
    public Square1(@NotNull Square other)
    {
        _a = other._a;
        _b = other._b;
        _c = other._c;
    ...
    {
        boolean ret = false;
        if (obj instanceof Square1)
            if (_a == ((Square1) obj)._a && _b == ((Square1) obj)._b && _c == ((Square1) obj)._c)
                ret = true;
        return ret;
    }
