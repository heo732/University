...
{
	if((y2_s>y1_s && y2_s<y1_e && y2_e>y1_e)||(y1_e>y2_e && y1_e<y2_s && y1_s>y2_s))
		{
			Form1->Image1->Canvas->MoveTo(x2_s,y2_s);
			Form1->Image1->Canvas->LineTo(x1_e,y1_e);
		}
	if((y2_e>y1_s && y2_e<y1_e && y2_s>y1_e)||(y1_e>y2_s && y1_e<y2_e && y1_s>y2_e))	
		{
			Form1->Image1->Canvas->MoveTo(x2_e,y2_e);
			Form1->Image1->Canvas->LineTo(x1_e,y1_e);
		}
	if((y2_s>y1_e && y2_s<y1_s && y2_e>y1_s)||(y1_s>y2_e && y1_s<y2_s && y1_e>y2_s))
		{
			Form1->Image1->Canvas->MoveTo(x2_s,y2_s);
			Form1->Image1->Canvas->LineTo(x1_s,y1_s);
		}
	if((y2_e>y1_e && y2_e<y1_s && y2_s>y1_s)||(y1_s>y2_s && y1_s<y2_e && y1_e>y2_e))		
		{
			Form1->Image1->Canvas->MoveTo(x2_e,y2_e);
			Form1->Image1->Canvas->LineTo(x1_s,y1_s);
		}
	...
	if(!(x1_s==x2_s && x1_e==x2_e))
		{
			if((x2_s>x1_s && x2_s<x1_e && x2_e>x1_e)||(x1_e>x2_e && x1_e<x2_s && x1_s>x2_s))
				{
					Form1->Image1->Canvas->MoveTo(x2_s,y2_s);
					Form1->Image1->Canvas->LineTo(x1_e,y1_e);
				}
			if((x2_e>x1_s && x2_e<x1_e && x2_s>x1_e)||(x1_e>x2_s && x1_e<x2_e && x1_s>x2_e))	
				{
					Form1->Image1->Canvas->MoveTo(x2_e,y2_e);
					Form1->Image1->Canvas->LineTo(x1_e,y1_e);
				}
			if((x2_s>x1_e && x2_s<x1_s && x2_e>x1_s)||(x1_s>x2_e && x1_s<x2_s && x1_e>x2_s))
				{
					Form1->Image1->Canvas->MoveTo(x2_s,y2_s);
					Form1->Image1->Canvas->LineTo(x1_s,y1_s);
				}
			if((x2_e>x1_e && x2_e<x1_s && x2_s>x1_s)||(x1_s>x2_s && x1_s<x2_e && x1_e>x2_e))		
				{
					Form1->Image1->Canvas->MoveTo(x2_e,y2_e);
					Form1->Image1->Canvas->LineTo(x1_s,y1_s);
				}
...
X=d1/d;
Y=d2/d;
Form1->Edit14->Text=Form1->Edit14->Text+" в точц≥ ("+FloatToStr(X)+"; "+FloatToStr(Y)+")";
Form1->Image1->Canvas->Pen->Width=7;
...
if((x1_s==x2_s && y1_s==y2_s)||(x1_s==x2_e && y1_s==y2_e))
	{
		Form1->Edit14->Text=Form1->Edit14->Text+" в точц≥ ("+FloatToStr(x1_s)+"; "+FloatToStr(y1_s)+")";
		Form1->Image1->Canvas->Pen->Width=7;
		Form1->Image1->Canvas->Pen->Color=clBlack;
		Form1->Image1->Canvas->MoveTo(x1_s,y1_s);
		Form1->Image1->Canvas->LineTo(x1_s,y1_s);
	...
	{
		Form1->Edit14->Text=Form1->Edit14->Text+" в точц≥ ("+FloatToStr(x1_e)+"; "+FloatToStr(y1_e)+")";
		Form1->Image1->Canvas->Pen->Width=7;
		Form1->Image1->Canvas->Pen->Color=clBlack;
                                    ...
                                    &&(
                                       (
                                        ...
                                        ((y2_s>y1_s && y2_s<y1_e && y2_e>y1_e)||(y2_e>y1_s && y2_e<y1_e && y2_s>y1_e)||(y2_s>y1_e && y2_s<y1_s && y2_e>y1_s)||(y2_e>y1_e && y2_e<y1_s && y2_s>y1_s)||
                                         (y1_s>y2_s && y1_s<y2_e && y1_e>y2_e)||(y1_e>y2_s && y1_e<y2_e && y1_s>y2_e)||(y1_s>y2_e && y1_s<y2_s && y1_e>y2_s)||(y1_e>y2_e && y1_e<y2_s && y1_s>y2_s))
                                       )
                                       ||
                                       (
                                        (!(x1_s==x2_s && x1_e==x2_e))
                                        ...
                                        ((x2_s>x1_s && x2_s<x1_e && x2_e>x1_e)||(x2_e>x1_s && x2_e<x1_e && x2_s>x1_e)||(x2_e>x1_e && x2_s<x1_s && x2_e>x1_s)||(x2_e>x1_e && x2_e<x1_s && x2_s>x1_s)||
                                         (x1_s>x2_s && x1_s<x2_e && x1_e>x2_e)||(x1_e>x2_s && x1_e<x2_e && x1_s>x2_e)||(x1_s>x2_e && x1_s<x2_s && x1_e>x2_s)||(x1_e>x2_e && x1_e<x2_s && x1_s>x2_s))
                                        )
                                      )
                                   )
                                        return '2';
                                	...
                                	if(
                                				   (Pidstanovka(a1,b1,c1,x1_s,y1_s)=='=' &&Pidstanovka(a1,b1,c1,x1_e,y1_e)=='=' && Pidstanovka(a1,b1,c1,x2_s,y2_s)=='=' && Pidstanovka(a1,b1,c1,x2_e,y2_e)=='=') //lezhat na odnij pr9mij
                                        			...
                                        			((y2_s==y1_e && y2_e>y2_s)||(y2_s==y1_s && y2_e>y2_s)||(y2_e==y1_s && y2_s>y2_e)||(y2_e==y1_e && y2_s>y2_e)||
                                        			 (y1_s==y2_e && y1_e>y1_s)||(y1_s==y2_s && y1_e>y1_s)||(y1_e==y2_s && y1_s>y1_e)||(y1_e==y2_e && y1_s>y1_e))
                                       				)
                                       				||
                                       				(
                                        			(!(x1_s==x2_s && x1_e==x2_e))
			                                        ...
			                                        ((x2_s==x1_e && x2_e>x2_s && x2_e>x1_s)||(x2_s==x1_s && x2_e>x2_s && x2_e>x1_e)||(x2_e==x1_e && x2_s>x2_e && x2_s>x1_s)||(x2_e==x1_s && x2_s>x2_e && x2_s>x1_e)||
			                                         (x1_s==x2_e && x1_e>x1_s && x1_e>x2_s)||(x1_s==x2_s && x1_e>x1_s && x1_e>x2_e)||(x1_e==x2_e && x1_s>x1_e && x1_s>x2_s)||(x1_e==x2_s && x1_s>x1_e && x1_s>x2_e))			                                        
                                        			)
                                      			   )
                                		  		  )
                                				return '3'; 
...
if(Dovzh(x1_start,y1_start,x1_end,y1_end)==0 || Dovzh(x2_start,y2_start,x2_end,y2_end)==0)
        Form1->Edit13->Text="неможливо визначити";
else
...
if(Dovzh(x1_start,y1_start,x1_end,y1_end)==0 || Dovzh(x2_start,y2_start,x2_end,y2_end)==0)
        {Form1->Edit14->Text="неможливо визначити"; Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);}
else
        {
        Form1->Edit14->Text="";
        ...
        switch(per)
                ...
                case 'p':
                        ...
                        if(fabs(KutOx(x2_start,y2_start,x2_end,y2_end)-KutOx(x1_start,y1_start,x1_end,y1_end))==90)
                                Form1->Edit14->Text="перпендикул€рн≥ та перетинаютьс€";
                        else
                                Form1->Edit14->Text="перетинаютьс€";
                ...
                case 'd':
                        {
                        if(fabs(KutOx(x2_start,y2_start,x2_end,y2_end)-KutOx(x1_start,y1_start,x1_end,y1_end))==90)
                                Form1->Edit14->Text="перпендикул€рн≥ та дотикаютьс€";
                        else
                                Form1->Edit14->Text="дотикаютьс€";
                        Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);
                        Intersection_point(q[0],q[1],q[2],q[3],q[4],q[5]);
                        break;
                        }
                case 'n':
                        ...
                        if(fabs(KutOx(x2_start,y2_start,x2_end,y2_end)-KutOx(x1_start,y1_start,x1_end,y1_end))==0)
                                Form1->Edit14->Text="паралельн≥";
                        else
                                if(fabs(KutOx(x2_start,y2_start,x2_end,y2_end)-KutOx(x1_start,y1_start,x1_end,y1_end))==90)
                                Form1->Edit14->Text="перпендикул€рн≥, не перетинаютьс€";
                                else
                                        Form1->Edit14->Text="не перетинаютьс€";
                        Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);
                        break;
                        }
                case '1':{Form1->Edit14->Text="зб≥гаютьс€"; Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end); break;}
                case '2':
                        {
                        Form1->Edit14->Text="накладаютьс€";
                        Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);
                ...
                case '3':
                        {
                        Form1->Edit14->Text="лежать на одн≥й пр€м≥й та дотикаютьс€";
                        Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);
                        Intersection_point_2(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end);
                        break;
                        }
                case '4':{Form1->Edit14->Text="другий в≥др≥зок належить першому"; Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end); break;}
                case '5':{Form1->Edit14->Text="перший в≥др≥зок належить другому"; Draw_2_1(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end); break;}
                case '6':{Form1->Edit14->Text="лежать на одн≥й пр€м≥й"; Draw(x1_start,y1_start,x1_end,y1_end,x2_start,y2_start,x2_end,y2_end); break;}
                }
        }
