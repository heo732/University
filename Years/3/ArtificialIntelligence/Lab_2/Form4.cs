...
namespace Lab_2
{
    public partial class Form_Sensitivity : Form
    {
        ...
        private void Form_Sensitivity_Load(object sender, EventArgs e)
        {
            ...
            label_Epoch.Text = form_Main.neiron.GetEpoch().ToString();
            textBox1.Text = form_Main.neiron.thresholdOfSensitivity.ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                form_Main.neiron.thresholdOfSensitivity = value;
            }
            else
                MessageBox.Show("Введіть цілочислове значення!", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
